...
public class AdvancementsAnimator {
    ...
    public static AnimationScope beginWindow(AdvancementsScreen screen, GuiGraphics graphics) {
    ...
    public static AnimationScope beginTab(Screen screen, GuiGraphics graphics, int tabIndex) {
        ...
        return AnimationSystem.begin(graphics, profile, 0, 0, TAB_WIDTH, TAB_HEIGHT, startTime, cascadeDelay, parentAlpha);
    }
}