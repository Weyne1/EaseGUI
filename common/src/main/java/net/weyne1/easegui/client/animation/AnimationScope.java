...
public class AnimationScope implements AutoCloseable {
    ...
    public void suspend() {
        if (isClosed || graphics == null) return;
    ...
    private static final class NoOpAnimationScope extends AnimationScope {
        ...
        @Override public void pushTransforms(float pX, float pY, float s) {}
        @Override public void pushTransforms(float pX, float pY, float sX, float sY) {}
