...
public class PictureInPictureRendererMixin {
    ...
    @WrapOperation(
            ...
            at = @At(
                    value = "NEW",
                    target = "Lnet/minecraft/client/gui/render/state/BlitRenderState;"
            )
    )
    private <T extends PictureInPictureRenderState> BlitRenderState easeGUI$applyAlphaToPipBlit(
            ...
            T renderState, GuiRenderState guiRenderState) {
