...
public class LogoAnimator {
    ...
    public static boolean render(GuiGraphics graphics, int screenWidth, float transparency, int height, boolean showEasterEgg, boolean keepLogoThroughFade) {
    ...
    private static void renderWholeLogo(GuiGraphics graphics, Identifier texture, AnimationProfile profile, int startX, int height, float finalAlpha) {
    ...
    private static void drawLogoTexture(GuiGraphics graphics, Identifier texture, int x, int y) {
