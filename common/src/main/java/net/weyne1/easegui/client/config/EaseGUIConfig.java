...
public class EaseGUIConfig {
    ...
    public EaseGUIConfig() {
        ...
        screens.put(EaseGUIScreenRegistry.OTHER.getId(), createDefaultSettingsFor(EaseGUIScreenRegistry.OTHER));
    }
    ...
    public boolean mergeDefaults() {
        ...
        if (!this.screens.containsKey(EaseGUIScreenRegistry.OTHER.getId())) {
            this.screens.put(EaseGUIScreenRegistry.OTHER.getId(), createDefaultSettingsFor(EaseGUIScreenRegistry.OTHER));
            changed = true;
        }
